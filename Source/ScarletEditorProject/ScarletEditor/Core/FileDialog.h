...
public:
    ...
    /**
     * @brief Open an "Open Folder" dialog. This will allow the user to pick a directory.
     * @return The absolute filepath of the chose folder. Empty string if the operation was cancelled.
     */
