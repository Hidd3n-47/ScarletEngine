...
def create_project_files(engine_path, project_name, project_path, starting_scene_name):
    ...
    # =========== Premake File.
    with (open(engine_path + "/EngineAssets/ProjectTemplates/premake5.lua.scarlet_template", "r") as f):
    ...
    # =========== Defines.h
    with (open(engine_path + "EngineAssets/ProjectTemplates/Defines.h.scarlet_template", "r") as f):
        file_template_str = f.read()
    ...
    # =========== Game.h
    with (open(engine_path + "EngineAssets/ProjectTemplates/Game.h.scarlet_template", "r") as f):
        file_template_str = f.read()
    ...
    # =========== Game.cpp
    with (open(engine_path + "EngineAssets/ProjectTemplates/Game.cpp.scarlet_template", "r") as f):
        file_template_str = f.read()
    ...
    # =========== StartingScene.h
    with (open(engine_path + "EngineAssets/ProjectTemplates/StartingScene.h.scarlet_template", "r") as f):
        file_template_str = f.read()
    ...
    with (open(engine_path + "EngineAssets/ProjectTemplates/StartingScene.scarlet_scene.scarlet_template", "r") as f):
        file_template_str = f.read()
