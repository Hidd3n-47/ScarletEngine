...
-- ---------------------------- ScarletDemoProject Project.
project "ScarletDemoProject"
    kind "SharedLib"
    language "C++"
    staticruntime "Off"
    cppdialect "C++20"

    targetdir(path.join("E:/Programming/ScarletEngine/ScarletProjects/ScarletDemoProject/", "Scratch/Bin/", "%{prj.name}"))
    objdir(path.join("E:/Programming/ScarletEngine/ScarletProjects/ScarletDemoProject/", "Scratch/Bin-Int/", "%{prj.name}"))
